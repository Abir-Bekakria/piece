...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BR9RHv2B.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DKpjGn-l.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "piece";
var SERVER_FN_BASE = "/piece/_serverFn/";
