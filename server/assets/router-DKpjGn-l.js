...
const appCss = "/piece/assets/styles-BNHpaUf2.css";
const dict = {
  // Header
...
function I18nProvider({ children }) {
  ...
  reactExports.useEffect(() => {
    ...
    const saved = localStorage.getItem("ppdz-lang");
  ...
  const t = (key) => dict[key]?.[lang] ?? String(key);
...
function ThemeProvider({ children }) {
  ...
  reactExports.useEffect(() => {
    if (typeof window === "undefined") return;
    const saved = localStorage.getItem("ppdz-theme");
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Pieces Pro DZ — Pièces auto originales en Algérie" },
      {
        name: "description",
        content: "Pieces Pro DZ — La plateforme leader des pièces auto originales en Algérie. 500 000+ références, livraison dans 58 wilayas."
      },
      { name: "author", content: "Pieces Pro DZ" },
      { property: "og:title", content: "Pieces Pro DZ — Pièces auto originales en Algérie" },
      { property: "og:description", content: "500 000+ pièces auto certifiées, livraison rapide partout en Algérie." },
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(I18nProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) });
}
const $$splitComponentImporter = () => import("./index-Cj_crMEu.js");
