import { r as reactExports, T as jsxRuntimeExports, S as React } from "./worker-entry-nerz2OAf.js";
import { u as useI18n, L as Link } from "./router-DKpjGn-l.js";
import "node:events";
...
function animateTarget(visualElement, targetAndTransition, { delay: delay2 = 0, transitionOverride, type } = {}) {
  let { transition: transition2, transitionEnd: transitionEnd2, ...target } = targetAndTransition;
  const defaultTransition = visualElement.getDefaultTransition();
  transition2 = transition2 ? resolveTransition(transition2, defaultTransition) : defaultTransition;
  const reduceMotion = transition2?.reduceMotion;
...
function isHTMLElement(element) {
  return isObject$3(element) && "offsetHeight" in element && !("ownerSVGElement" in element);
}
...
function isSVGElement(element) {
  return isObject$3(element) && "ownerSVGElement" in element;
}
...
const CarFront = createLucideIcon("car-front", __iconNode$v);
const __iconNode$u = [
  [
    "path",
    {
...
const Car = createLucideIcon("car", __iconNode$u);
...
const Disc = createLucideIcon("disc", __iconNode$n);
const __iconNode$m = [
  [
    "path",
...
const Headphones = createLucideIcon("headphones", __iconNode$l);
const __iconNode$k = [
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 w-full border-b-4 border-white bg-[#0a0f1a] text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex h-16 items-center justify-between px-4 md:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "group flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 items-center justify-center border-2 border-white bg-transparent shadow-[3px_3px_0px_0px_rgba(255,255,255,1)] transition-all group-hover:bg-[var(--orange)] group-hover:border-slate-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "h-5 w-5 text-white group-hover:text-slate-900" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xl font-black uppercase italic tracking-tighter", children: [
            "PIECES PRO",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--orange)]", children: "." }),
            "DZ"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-mono font-bold uppercase tracking-[0.2em] text-slate-400", children: "Engineering & Sourcing" })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "hidden h-9 items-center gap-2 border-2 border-white px-3 text-[11px] font-black uppercase italic shadow-[2px_2px_0px_0px_rgba(255,255,255,1)] transition-all hover:bg-white hover:text-slate-900 sm:inline-flex", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-4 w-4" }),
          t("nav.login")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "relative flex h-9 w-9 items-center justify-center border-2 border-white bg-[var(--orange)] text-white shadow-[2px_2px_0px_0px_rgba(255,255,255,1)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-2 -right-2 flex h-5 w-5 items-center justify-center border-2 border-white bg-[#0a0f1a] text-[10px] font-black text-white", children: "0" })
        ] }),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "container mx-auto flex flex-col gap-1 px-4 py-4", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: item.href,
...
const heroImg = "/piece/assets/hero-engine-DlAd1FQA.jpg";
const BRANDS$1 = ["Hyundai", "Kia", "Toyota", "Renault", "Peugeot", "BMW", "Ford", "Volkswagen"];
...
function Select({ label, value, options, onChange }) {
  return (
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-w-0 border-r border-slate-200/50 last:border-r-0 bg-slate-50/80 hover:bg-white transition-colors group", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "absolute left-4 top-3 text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 group-hover:text-[var(--orange)] transition-colors", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", className: "font-sans text-gray-400", children: "Sélectionner" }),
            options.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: item, className: "font-sans font-medium text-gray-900", children: item }, item))
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "pointer-events-none absolute right-3 bottom-5 h-3.5 w-3.5 text-[var(--orange)] opacity-50 group-hover:opacity-100 transition-opacity" })
    ] })
  );
}
function Hero() {
  ...
  const [partType, setPartType] = reactExports.useState("");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-[90vh] md:min-h-screen overflow-hidden bg-[#050a15] flex items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-10 via-[#050a15]/90 to-transparent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.img,
        {
          src: heroImg,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-20 container mx-auto px-6 py-20 lg:py-32", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-[2px] w-10 bg-[var(--orange)]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-black uppercase tracking-[0.5em] text-[var(--orange)]", children: "Pièces Pro DZ • Excellence" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-6xl md:text-8xl font-black uppercase italic leading-[0.85] tracking-[-0.05em] text-white", children: [
              t("hero.title1") || "Expert en",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stroke-text", children: "Pièces Auto" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-white/40 text-sm md:text-base font-bold uppercase tracking-widest max-w-lg border-l-2 border-white/5 pl-6", children: "Trouvez rapidement la pièce parfaite pour votre véhicule parmi +500,000 références." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: ["vehicle", "plate"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                onClick: () => setActiveTab(tab),
                className: `relative px-10 py-4 text-[10px] font-black uppercase tracking-[0.3em] transition-all duration-300 overflow-hidden ${activeTab === tab ? "bg-slate-100 text-[#050a15]" : "bg-white/5 text-white/30 hover:bg-white/10 backdrop-blur-md"}`,
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative z-10", children: tab === "vehicle" ? "Par Véhicule" : "Par Matricule" })
                ]
              },
              tab
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden bg-slate-100 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.6)] border-b-8 border-[var(--orange)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col xl:flex-row items-stretch", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: activeTab === "vehicle" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Select, { label: "1. Marque", value: brand, options: BRANDS$1, onChange: setBrand }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Select, { label: "2. Modèle", value: model, options: MODELS, onChange: setModel }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Select, { label: "3. Année", value: year, options: YEARS, onChange: setYear }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Select, { label: "4. Moteur", value: engine, options: ENGINES, onChange: setEngine })
                  ]
                },
                "vehicle"
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full max-w-md items-center gap-4 rounded-sm border-2 border-slate-300/50 bg-white/80 p-3 shadow-inner backdrop-blur-sm", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-sm bg-blue-700 px-2 py-1 text-[10px] font-black text-white", children: "DZ" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        value: plate,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "h-6 w-6 text-slate-300" })
                  ] })
                },
                "plate"
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 items-center border-t border-slate-200/50 px-10 xl:border-l xl:border-t-0 bg-slate-50/50 group transition-colors hover:bg-white", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "mr-5 h-5 w-5 text-slate-300 group-focus-within:text-[var(--orange)] transition-colors" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    value: partType,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "flex shrink-0 items-center justify-center gap-4 bg-[var(--orange)] px-14 py-9 text-2xl font-black italic uppercase tracking-tighter text-white transition-all duration-300 hover:bg-black group", children: [
                "RECHERCHER",
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-6 w-6 group-hover:translate-x-3 transition-transform" })
              ] })
            ] }) })
          ]
        }
...
function Categories() {
  const { t } = useI18n();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "categories", className: "py-24 bg-white overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font- uppercase tracking-tighter italic text-[var(--navy-deep)]", children: t("cat.title") })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 border-t border-l border-border shadow-sm", children: CATS.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.button,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: "h-12 w-12 stroke-[1.25px] group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-white/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font- uppercase tracking-[0.15em] mb-1", children: t(c.key) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-bold opacity-50 group-hover:opacity-90 tracking-widest", children: [
            c.count.toLocaleString(),
            " ITEMS"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 right-2 w-1 h-1 bg-border group-hover:bg-white/40 transition-colors" })
        ]
      },
      c.key
    )) })
...
const img1 = "/piece/assets/1-CqBhFvpR.jpg";
const img2 = "/piece/assets/2-BRYqy9vh.jpg";
const img3 = "/piece/assets/3-D-re0jjx.jpg";
const img4 = "/piece/assets/4-Drx0puLg.png";
const PRODUCTS = [
  {
    id: "1",
...
function BestSellers() {
  const { t } = useI18n();
  const [swiperInstance, setSwiperInstance] = reactExports.useState(null);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "overflow-hidden bg-slate-50/50 py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[2px] w-12 bg-[var(--orange)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase tracking-[0.4em] text-[var(--orange)]", children: "Stock direct" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl font-black uppercase italic leading-none tracking-tighter text-slate-900 md:text-6xl", children: [
            "MEILLEURES VENTES",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--orange)]", children: "." })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Swiper2,
        {
          ...
          children: PRODUCTS.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative flex h-[520px] flex-col border border-slate-100 bg-white transition-all duration-500 hover:shadow-2xl hover:shadow-slate-200/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 top-4 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-slate-900 px-3 py-1.5 text-[9px] font-black uppercase tracking-widest text-white", children: p.badge }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex h-64 w-full items-center justify-center overflow-hidden bg-slate-50 p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.img,
              {
                src: p.image,
                alt: p.name,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col p-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 flex items-center gap-1 text-[var(--orange)]", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "h-3 w-3 fill-current" }, i)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-4 line-clamp-2 text-lg font-black uppercase italic leading-tight text-slate-900 group-hover:text-[var(--orange)]", children: p.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto flex items-end justify-between border-t border-slate-50 pt-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] font-bold text-slate-400 line-through", children: [
                    p.oldPrice,
                    " DA"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-black tracking-tighter text-slate-900", children: [
                    p.price,
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-[10px] uppercase text-slate-400", children: "DA" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.button,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-6 w-6 stroke-[3px]" })
                  }
                )
              ] })
            ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "custom-pagination-line flex h-1 w-full max-w-[240px] gap-2" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
...
function OrderTracking() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 p-4 opacity-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "h-32 w-32 rotate-12" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 items-center justify-center bg-[var(--orange)] shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "h-6 w-6 text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-black uppercase tracking-tighter italic", children: t("track.title") || "SUIVI DE COMMANDE" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-[10px] font-black uppercase tracking-widest text-white/50 mb-2 ml-1", children: "NUMÉRO DE COMMANDE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  value: orderId,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "h-5 w-5 group-hover:scale-110 transition-transform" }),
                  t("track.button") || "SUIVRE MON COLIS"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-center text-white/40 font-bold uppercase tracking-widest mt-4", children: "Service disponible 24/7 pour vos pièces" })
          ] })
        ] })
      ]
    }
...
function WhyUs() {
  const { t } = useI18n();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 md:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-3 gap-0 border border-gray-200", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-2 bg-[var(--orange)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-black uppercase tracking-tighter italic text-[var(--navy-deep)]", children: t("why.title") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-6", children: ITEMS.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 flex h-14 w-14 items-center justify-center bg-[var(--navy-deep)] text-white group-hover:bg-[var(--orange)] transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(it.icon, { className: "h-7 w-7 stroke-[1.5px]" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-black uppercase tracking-tight text-sm text-[var(--navy-deep)] mb-1", children: t(it.key) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 w-3 bg-[var(--orange)]" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-50 flex flex-col justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OrderTracking, {}) })
  ] }) }) });
}
const BRANDS = [
  "HYUNDAI",
...
function BrandsBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 bg-card border-y border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex marquee whitespace-nowrap gap-12 px-6", children: list.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 start-0 w-24 bg-gradient-to-r from-card to-transparent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 end-0 w-24 bg-gradient-to-l from-card to-transparent" })
  ] }) });
}
const categories = [
...
function PartsCatalog() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[#fafafa] py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-20 flex flex-col gap-12 lg:flex-row lg:items-end lg:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-[3px] w-8 bg-[var(--orange)]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-black uppercase tracking-[0.4em] text-[var(--orange)]", children: "Catalogue Technique 2026" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl font-black uppercase italic leading-none tracking-tighter text-slate-900 md:text-6xl", children: [
          "Pièces Catalogue ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--orange)]", children: "." })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-[var(--orange)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-px overflow-hidden bg-slate-200 sm:grid-cols-2 lg:grid-cols-3", children: categories.map((cat, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-2 rounded-full bg-[var(--orange)] opacity-0 blur-lg transition-opacity group-hover:opacity-20" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(cat.icon, { className: "relative h-8 w-8 text-slate-900 transition-transform duration-500 group-hover:scale-110 group-hover:text-[var(--orange)]" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] font-bold text-slate-300", children: [
              "[",
              cat.count,
              " ITEMS]"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-6 text-2xl font-black uppercase italic tracking-tight text-slate-950", children: cat.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-10 flex flex-wrap gap-x-4 gap-y-2", children: cat.links.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "#",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "group/btn flex items-center gap-3 text-[11px] font-black uppercase tracking-[0.3em] text-slate-900", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Consulter" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-full border border-slate-200 transition-all group-hover/btn:border-[var(--orange)] group-hover/btn:bg-[var(--orange)] group-hover/btn:text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 h-[3px] w-0 bg-[var(--orange)] transition-all duration-500 group-hover:w-full" })
        ]
      },
      idx
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-20 flex flex-col items-center justify-between gap-8 md:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-black text-slate-900", children: "+50K" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-bold uppercase tracking-widest text-slate-400 text-nowrap", children: "Références en stock" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-[1px] bg-slate-200 hidden md:block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-black text-slate-900", children: "24H" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-bold uppercase tracking-widest text-slate-400 text-nowrap", children: "Livraison Express" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.button,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-5 w-5 transition-transform group-hover:translate-x-2" })
          ]
        }
      )
    ] })
...
function RarePartCTA() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-[var(--navy-deep)] py-10 border-b-4 border-[var(--orange)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 md:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5 text-center md:text-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-14 w-14 shrink-0 bg-[var(--orange)] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "h-7 w-7 text-white stroke-[2.5px]" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl md:text-2xl font-black uppercase tracking-tighter text-white italic", children: t("rare.title") || "PIÈCE INTROUVABLE ?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs md:text-sm font-bold uppercase mt-1 text-white/60 tracking-widest", children: t("rare.banner") || "Service de recherche spécialisé en Algérie" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.button,
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-50 p-6 flex items-center justify-between border-b border-gray-100", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-8 bg-[var(--orange)]" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-black uppercase tracking-tighter italic text-[var(--navy-deep)]", children: t("rare.modalTitle") || "CONFIGURATEUR DE RECHERCHE" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-6 w-6 stroke-[3px]" })
                  }
                )
              ] }),
              !done && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-full h-2 bg-gray-100", children: [1, 2, 3].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `flex-1 transition-all duration-500 ${s <= step ? "bg-[var(--orange)]" : "bg-transparent"}`
                },
                s
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 flex-1 overflow-y-auto", children: done ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 flex flex-col items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 h-24 w-24 bg-green-600 text-white flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-12 w-12 stroke-[4px]" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-2xl font-black uppercase italic mb-2 text-[var(--navy-deep)]", children: "SUCCÈS !" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-gray-400 uppercase tracking-widest text-xs mb-10", children: "Votre demande est en cours de traitement" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    onClick: close,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-black tracking-[0.3em] text-gray-300 uppercase", children: [
                    "STEP 0",
                    step,
                    " / 03"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-black uppercase text-sm text-[var(--navy-deep)] tracking-tighter", children: [
                    step === 1 && (t("rare.vehicleInfo") || "VÉHICULE"),
                    step === 2 && (t("rare.partInfo") || "DÉTAILS PIÈCE"),
                    step === 3 && (t("rare.contactInfo") || "COORDONNÉES")
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "select",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "WILAYA DE LIVRAISON" }),
                            WILAYAS.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: w, children: w }, w))
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-5 top-1/2 -translate-y-1/2 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-4 w-4 rotate-[-90deg] text-gray-300" }) })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 mt-10", children: [
                  step > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Prev, { className: "h-4 w-4 stroke-[3px]" }),
                        t("rare.back") || "RETOUR"
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      children: [
                        step === 3 ? t("rare.submit") || "ENVOYER" : t("rare.next") || "SUIVANT",
                        step < 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(Next, { className: "h-4 w-4 stroke-[3px]" })
                      ]
                    }
                  )
                ] })
...
function CustomInput({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 h-[2px] w-0 bg-[var(--orange)] transition-all duration-300 group-focus-within:w-full" })
  ] });
}
function ContactLink({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group flex items-start gap-4 cursor-pointer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "mt-1 h-4 w-4 text-[var(--orange)] transition-transform group-hover:scale-110" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-1 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold uppercase tracking-widest text-slate-900", children: value })
    ] })
  ] });
}
function ContactSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-white py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-orange-50" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-24 -top-24 h-72 w-72 rounded-full bg-orange-200/40 blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-24 -left-24 h-72 w-72 rounded-full bg-slate-200/50 blur-3xl" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container relative z-10 mx-auto px-4 md:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid items-start gap-16 lg:grid-cols-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-12 lg:col-span-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[2px] w-12 bg-[var(--orange)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black uppercase tracking-[0.4em] text-[var(--orange)]", children: "Get in touch" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-5xl font-black uppercase italic leading-none tracking-tighter text-slate-900 md:text-7xl", children: [
            "CONTACT",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--orange)]", children: "." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-md text-sm font-medium uppercase tracking-wide leading-relaxed text-slate-500", children: "Besoin d'une expertise technique ou d'une pièce introuvable ?" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 border-t border-slate-200 pt-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-5 w-5 text-[var(--orange)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase tracking-widest text-slate-400", children: "Response under 24h" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "h-5 w-5 text-[var(--orange)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-black uppercase tracking-widest text-slate-400", children: "Secure Protocol" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/50 md:p-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-0 top-0 h-16 w-16 border-r-2 border-t-2 border-[var(--orange)]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-10 text-xl font-black uppercase italic tracking-tighter text-slate-900", children: "Lancer une requête" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center justify-between px-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-mono tracking-widest text-slate-400", children: "SRL-X99-2026" }),
...
function Footer() {
  ...
  return (
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { id: "footer", className: "bg-white border-t-4 border-slate-900 pt-8 pb-4 mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 md:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 items-center justify-center border-2 border-slate-900 bg-white shadow-[3px_3px_0px_0px_rgba(15,23,42,1)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "h-5 w-5 text-[var(--orange)]" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-black italic text-xl tracking-tighter text-slate-900 uppercase leading-none", children: [
              "PIECES PRO",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--orange)]", children: "." }),
              "DZ"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-mono font-bold text-slate-400 tracking-[0.2em] uppercase", children: "Engineering & Sourcing" })
          ] })
        ] }),
        ...
        ].map(({ Icon: Icon2, label }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: "#",
            ...
            "aria-label": label,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-3.5 w-3.5 text-slate-900 transition-colors group-hover:text-white" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-1 -right-1 h-1.5 w-1.5 bg-[var(--orange)] opacity-0 group-hover:opacity-100" })
            ]
          },
          i
        )) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:flex md:flex-wrap gap-x-8 gap-y-3 py-4 border-y border-slate-100", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:justify-between items-center gap-4 pt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[1px] w-6 bg-[var(--orange)]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest", children: [
            t("footer.rights"),
            " — 2026"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[7px] font-black text-slate-200 uppercase tracking-[0.3em]", children: "Verified Parts Protocol" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [...Array(6)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-2 w-[2px] bg-slate-100 ${i % 2 === 0 ? "bg-slate-200 h-3" : ""}` }, i)) })
        ] })
      ] })
    ] }) })
  );
...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(RarePartCTA, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PartsCatalog, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(BrandsBar, {}),
